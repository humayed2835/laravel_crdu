...
@section('content')
    ...
    <div class="section ">
        <div class="hero-slider swiper-container slider-nav-style-1 slider-dot-style-1">
            ...
            <div class="swiper-wrapper">
                <!-- Single slider item -->
                @foreach($banner_all as $bannners)☻◘
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-5 col-md-5 col-sm-5 align-self-center sm-center-view">
                                <div class="hero-slide-content hero-slide-content-2 slider-animated-1">
                                    <span class="category">{{ $bannners->banner_title }}</span>
                                    <h2 class="title-1">{{ $bannners->banner_name }}</h2>
                            ...
                            <div class="col-xl-6 col-lg-7 col-md-7 col-sm-7 d-flex justify-content-center position-relative">
                                <div class="show-case">
                                    <div class="hero-slide-image">
                                        <img src="{{ asset('Uploads/banner_photo') }}/{{ $bannners->banner_image }}" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!-- Deal Area Start -->
    <div class="deal-area deal-bg deal-bg-2" data-bg-image="{{ asset('frontend_asset') }}/assets/images/deal-img/deal-bg-2.jpg">
        <div class="container ">
            <div class="row">
                <div class="col-12">
